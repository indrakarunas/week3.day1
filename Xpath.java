...
public class Xpath {
	...
	public static void main(String[] args) {
				...
				//driver.findElement=driver.findElement(By.Xpath["//input[@id='username'));
				...
				//driver.findElement(By.By.Xpath["//input[@id='createLeadForm_companyName')).sendKeys("TestLeaf");
				//driver.findElement(By.("createLeadForm_firstName")).sendKeys("Satvik");
